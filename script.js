$(function () {
  ...
  function moveVariable(mX, mY) {
    ...
    const percentageOfDistanceFromVisual = calculatePercentage(visualDistance, VAR_MAX_DISTANCE);
    const calculatedVisualWeight = `'wght' ${calculateSpan(percentageOfDistanceFromVisual, settings.minWeight, settings.maxWeight)}`;
